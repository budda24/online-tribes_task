...
class GetTribeOnboardingContentUseCase {
  final OnboardingRepository repository;

  GetTribeOnboardingContentUseCase(this.repository);

  Future<Either<BaseApiError, List<OnboardingScreenContent>>> call(
    Language currantLanguage,
  ) {
    return repository.getTribeOnboardingScreenContent(currantLanguage);
  }
}
