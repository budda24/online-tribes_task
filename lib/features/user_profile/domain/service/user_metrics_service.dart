...
class UserMetricsService {
  // Filters data points to include only those from the past 30 days
  ...
  List<FlSpot> getFlSpotsForMetric(
    ...
    final minValue = UserEngagementMetrics.findMinValue(aggregatedDataPoints);
    final maxValue = UserEngagementMetrics.findMaxValue(aggregatedDataPoints);
